...
const Dashboard = () => {
  ...
  return (
    <div>
      <Title aligh='left' font='outfit' title='Dashboard' subTitle="Monitor your room listings, track bookings and analyze revenue- all in one place. Stay updated with real time insights to ensure smooth operation"/> 
