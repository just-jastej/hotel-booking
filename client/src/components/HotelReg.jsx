...
const HotelReg = () => {
  return (
    <div onClick={()=> setShowHotelReg(false)} className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        <form 
          // OnSubmit={handleHotelReg} 
          onClick={(e)=> e.stopPropagation()} className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            <img src={assets.regImage} alt="reg-image" className='1/2 rounded-xl hidden  md:block' />
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
              ...
              <p lassName='mt-6 text-2xl font-semibold'>Register Your Hotel</p>

              <div className='w-full mt-4'>
                <label tmlFor='name' className='text-gray-500 font-medium' >Hotel Name</label>
